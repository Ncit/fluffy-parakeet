...
- [x] Add deterministic scene loading from external files, not only `include_str!`
...
2. Add README and DSL docs.
3. Start text node rendering.
4. Add renderer/editor bridge.
5. Add image node rendering.
